...
const Navbar = () => {
  ...
  return (
    <div className='navbar'>
      <h1 className='navbar-title'>DEEPAK</h1>
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li><AnchorLink className='anchor-link' offset={50} href='#skills'><p onClick={()=>setMenu("services")}>Skills</p></AnchorLink>{menu==="services"?<img src={underline} alt=''/>:<></>}</li>
